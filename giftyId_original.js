...
export default function ProfilePage({ profile, giftyId }) {
  const name = profile?.name || 'Gifty pou┼¥├¡vate─¥';

  return (
    <>
      <Head>
        <title>{`${name} ÔÇö Gifty Wishlist`}</title>
        <meta name="description" content="Pozri m├┤j wishlist a prispej presne na to ─ìo si prajem cez QR platbu." />
        <meta property="og:title" content={`Pozri m├┤j Gifty wishlist ­ƒÄü`} />
        <meta property="og:description" content="Zabudni na ob├ílky s peniazmi. Prispej presne na to ─ìo si prajem ÔÇö jedn├¢m skenovan├¡m QR k├│du." />
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <div className="heading">
              <em>{name}</em><br />┼Ña poz├¢va na Gifty
            </div>
            <p className="desc">
              Pozri m├┤j wishlist a prispej presne na to ─ìo si prajem ÔÇö jedn├¢m skenovan├¡m QR k├│du.
            </p>
